...
import it.seba.onlineshopping.exception.ProductNotFoundException;
...
public class PageController {
	...
	/*
	 *  Method to laod all the products and based on category
	 */
	...
	public ModelAndView showCategoryProducts(@PathVariable("id") int id) {
		...
		// passign the single category object
